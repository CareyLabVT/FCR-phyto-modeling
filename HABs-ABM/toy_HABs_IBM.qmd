...
2.  Movement of individuals given static water temp profile using turbulence/diffusion equation
    ...
    6.  Edit "growth" function
        ...
        1.  temperature-dependent growth rate, adapted from AED; probability of doubling is determined by temperature

        2.  add light column to environment

        3.  light-dependent growth rate, adapted from AED; probability of doubling is determined by maximum probability between temp and light functions
...
death <- function(inds, dcol = 6, yloc = 2, ymax = 9.3, pft = 1,
                  graze_d = 0.6/24, graze_c = 0.1/24, graze_g = 0.4/24){
  total_inds <- dim(inds)[1] # Get the number of individuals in inds
