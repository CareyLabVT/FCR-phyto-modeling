...
write.csv(plot_yloc.d, file = "./ABM_output/ABM_diatom_depthByTimestep.csv", row.names = FALSE)
write.csv(plot_ts.d, file = "./ABM_output/ABM_diatom_surfaceTimeseries.csv", row.names = FALSE)

write.csv(plot_yloc.c, file = "./ABM_output/ABM_cyano_depthByTimestep.csv", row.names = FALSE)
write.csv(plot_ts.c, file = "./ABM_output/ABM_cyano_surfaceTimeseries.csv", row.names = FALSE)

write.csv(plot_yloc.g, file = "./ABM_output/ABM_green_depthByTimestep.csv", row.names = FALSE)
write.csv(plot_ts.g, file = "./ABM_output/ABM_green_surfaceTimeseries.csv", row.names = FALSE)

write.csv(plot_ts.all, file = "./ABM_output/ABM_all_surfaceTimeseries.csv",row.names = FALSE)
write.csv(plot_ts.prop, file = "./ABM_output/ABM_allProp_surfaceTimeseries.csv",row.names = FALSE)

saveRDS(inds_hist, file = "ABM_output.rds")
```
