...
2.  Movement of individuals given static water temp profile using turbulence/diffusion equation
    ...
    4.  Edit "movement" function to use eq. 9 instead of random movement
        ...
        2.  next, worry about random walk to simulate turbulent transport --\> key here is if we want to use Visser's random walk formulation (which is well-established and probably a good choice) need to calculate vertical diffusivity from water temperature
